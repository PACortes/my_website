...
In this workshop, we will use a simulated dataset consisting of faculty employees information. The data set will be use for learning data visualization in R. You can download the database here {{< staticref "uploads/FacultyAffairs.xlsx" "newtab" >}}here {{< /staticref >}}.




In this workshop, we will work with a simulated dataset 
The data used in this workshop is a set used for learning data visualization.
...
![Credit: @allison_horst](/workshops/NEOMU/aboutr_files/r_rollercoaster.png)
