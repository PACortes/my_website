...
![](/workshops/neom/importing_files/setwd.png){width=600px height=300px}
...
`read.table("path/file_name.txt", header=TRUE)`
...
`read_excel("path/file_name.xlsx")`
