...
* La versión mas reciente de R <https://www.r-project.org>.
* RStudio <https://rstudio.com>.
* Instalar los paquetes `knitr` y `rmarkdown`. Podemos instalar cada paquete desde el CRAN con:
...
## 5.3. Visualicemos nuestros datos
