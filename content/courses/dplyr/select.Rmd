...
Ahora, seleccionemos las variables **Petal.Length** y **Petal.Width**. Eto lo podemos realizar nombrando las variables de interés:
...
## 2.6. Seleccionemos una variable que comienza con cierto carácter

## 2.7. Seleccionemos una variable que termina con cierto carácter

## 2.8. Seleccionemos una variable que contiene un valor
