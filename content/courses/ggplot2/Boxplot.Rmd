...
Ahora, generemos el mismo gráfico de cajas pero incluyamos una segunda variable categórica. Por ejemplo, podemos ver la distribución de la variable **PM2.5** para cada **Ciudad** en la que se levantó información.
