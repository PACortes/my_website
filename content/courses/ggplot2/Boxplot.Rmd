...
Generemos un gráfico de cajas para la variable dispersión con la variables **PM2.5**.
...
Ahora, generemos el mismo gráfico de cajas pero incluyamos una segunda variable categórica. Por ejemplo, podemos ver la distribución de la variable **PM2.5** dependiendo de la **Ciudad** en la cuál se levantó la información.
