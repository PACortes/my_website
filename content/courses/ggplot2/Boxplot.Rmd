...
## 4.3. Título y etiquetas
Ahora, mejoremos la calidad de nuestro gráfico. Primero, vamos a personalizar la información de las etiquetaas de los ejes y título del gráfico  con la función `labs()`. Además, vamos a aumentar el tamaño de cada una de estas etiquetas con la función `theme()`.
