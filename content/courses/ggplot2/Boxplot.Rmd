...
`ggplot(data, mapping=aes(x,y))+ box_point()`
...
* `box_point()`: Especifica que queremos generar un gráfico de cajas.

# 3. Base de datos

Para el presente tutorial, utilizaremos una base deel conjunto de datos **flor Iris**,  multivariante introducido por Sir. Ronald Fisher en su artículo de 1936, [The use of multiple measurements in taxonomic problems](https://onlinelibrary.wiley.com/doi/10.1111/j.1469-1809.1936.tb02137.x).
