...
## Título y etiquetas: tamaño de las letras
...
### Método 2: De acuerdo a categorías en otra variable.
...
ggplot(data = iris, mapping=aes(x=Petal.Length , y =Petal.Width))+
  ...
  theme(axis.text =element_text(size=16),
        ...
        plot.subtitle=element_text(size=20))
```
### Método 2: De acuerdo a categorías en otra variable con valores específicos.
