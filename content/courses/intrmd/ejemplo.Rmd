...
date: '2021-09-28T21:13:14-05:00'
categories: R
tags:
- RMarkdown
output:
...
# 1. Primer informe con RMarkdown
Generemos un pequeño informe en el cuál aplicaremos los conocimientos que hemos aprendido sobre las librerías `dplyr`, `ggplot2` y `rmarkdown`. Utilizaremos los datos de la base de datos **iris**. 

# 2.  Exploremos nuestros datos
...
Ahora, generemos un gráfico de dispersión.
