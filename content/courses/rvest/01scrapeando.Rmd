---
title: "Extraer datos desde una página específica"
...
# Extraer información desde el título de la noticia

*h1* es el elemento HTML utilizado para identificar la cabecera más importante en una página web, tales como el título de una página, el título de un post, el nombre de un producto, etc. <h1> es el más importante, y <h6>  el menos importante.
